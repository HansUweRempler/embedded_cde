...
data "coder_parameter" "repo" {
  ...
  option {
    name        = "swc-bios/sabat"
    description = "The SABAT project provides a suite of tools designed to facilitate model analysis and static code analysis, aimed at enhancing software architecture validation and integrity."
    value       = "https://github.boschdevcloud.com/bios-SABAT/SABATcore.git"
  }
  option {
    name        = "Custom"
    icon        = "/emojis/1f4be.png"
...
locals {
  ...
  envbuilder_env = {
    ...
    # See https://github.com/coder/coder/issues/13367 for envbuilder initial http(s) auth repo clone
    "GIT_USERNAME" : "${data.coder_parameter.github_user.value}",
    "GIT_PASSWORD" : "${data.coder_parameter.github_token.value}",
